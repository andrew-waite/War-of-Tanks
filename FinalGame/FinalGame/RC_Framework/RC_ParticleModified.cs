...
{
    public struct ParticleModified
    {
    ...
    public class ParticleSystemModified : RC_Renderable
    {
        Random rnd;
        ...
        public ParticleSystemModified(Vector2 posZ, int MaxnumZ, int ticksSystemDurationZ, int randomSeed)
        {
        ...
        public void makeParticles(int num)
        {
            ...
            for (int i = 0; i < maxNum; i++)
            {
                ...
                if (!particles[i].active)
                {
                 ...
                 if (Origin==0)
                    {
                        particles[i].pos.X = sysPos.X + offset.X; //position
                        particles[i].pos.Y = sysPos.Y + offset.Y; //position
                    }
                ...
                if (particles[i].active)
                {
                  ...
                  //  particles[i].vel = particles[i].vel + windDelta;
                   ...
                   // particles[0].active = false;     
                    ...
                    particles[i].displayAngle = displayAngleOffset;
            ...
            for (int i = 0; i < maxNum; i++)
            {
                ...
                if (particles[i].active)
                {
                    ...
                    if (setDisplayAngle)
                    {
                        ...
                        sp.Draw(particles[i].tex, dest, null, c, particles[i].displayAngle, new Vector2(20,20), SpriteEffects.None, 1f); //Change this one
                    }
                    else
                    {
                        //sp.Draw(particles[i].tex, dest, c);                        
