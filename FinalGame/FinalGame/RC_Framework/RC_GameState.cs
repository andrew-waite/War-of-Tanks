...
//  *********************************************************  RC_GameStateParent  *************************************************************
    ...
    public abstract class RC_GameStateParent
    {
        ...
        public static Game game; //Required to make a singleton to quit the application

        public virtual void InitializeLevel(GraphicsDevice g, SpriteBatch s, ContentManager c, RC_GameStateManager lm, Game game)
        {
            graphicsDevice = g;
            spriteBatch = s;
            Content = c;
